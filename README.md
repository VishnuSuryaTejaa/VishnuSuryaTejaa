...
vishnu = {
    "role"      : "AI/ML Engineer",
    "focus"     : ["LLM Systems", "Agentic Pipelines", "Full-Stack AI Integration"],
    "location"  : "Hyderabad, India 🇮🇳",
    "currently" : "Building Vorkos — cut job-search effort by ~70% with agentic RAG",
    "reading"   : "Liu et al. (2023) Lost in the Middle · SIGIR 2024 RAG retrieval papers",
    "belief"    : "The model is the least important variable. Retrieval is everything.",
    "goal"      : "Build where uniqueness is an advantage, not a liability"
}
```

> *"The gap between what foundation models can do in research and what actually works when deployed in the real world — that gap is where the most interesting engineering lives."*
...
<img src="https://img.shields.io/badge/RAG_Pipelines-0F6E56?style=for-the-badge&logoColor=white" />

### 🌐 Full-Stack & Deployment
![Stack](https://skillicons.dev/icons?i=react,flask,docker,aws,postgres,mongodb,git)
...
<img src="https://img.shields.io/badge/Gensim-0096D6?style=for-the-badge&logoColor=white" />

### 🔐 Security
<img src="https://img.shields.io/badge/OWASP_Top_10-000000?style=for-the-badge&logoColor=white" />
...
<img src="https://github-profile-trophy.vercel.app/?username=VishnuSuryaTejaa&theme=tokyonight&no-frame=true&no-bg=true&margin-w=4&column=4&rank=SECRET,SSS,SS,S,AAA,AA,A" width="100%" />
...
```
📌  Full-Stack AI Developer     Mallurus Industry Pvt Ltd     Nov 2024 – Sep 2025
    ↳ 6+ production web apps shipped · Groq AI chatbot deployed to live client site
    ↳ End-to-end: UI/UX → backend logic → AI integration

📌  Cybersecurity Intern         The Red Users                  Jan 2025 – Feb 2025
    ↳ Pen testing with Burp Suite, Nmap, Wireshark · OWASP Top 10
    ↳ Automated threat-scanning workflows with custom Python scripts

🎓  B.Tech Computing & Data Science (AIML)    SAI University    2023 – 2027
    ↳ ML · Deep Learning · NLP · Reinforcement Learning · MLOps · Cryptography
```
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:185FA5,50:0A4F8A,100:0F6E56&height=120&section=footer&animation=fadeIn" width="100%" />
